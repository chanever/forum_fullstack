...
const About = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-32 max-w-7xl">
      ...
      <motion.div
        className="relative rounded-2xl overflow-hidden shadow-2xl mb-24 aspect-video"
      ...
      >
        ...
        <div className="absolute bottom-8 left-8 md:bottom-12 md:left-12 text-white">
          <h3 className="text-2xl md:text-4xl font-bold mb-2 md:mb-3">신우전기</h3>
      ...
      >
        ...
        <div className="text-lg leading-relaxed text-gray-600 space-y-6">
          <p>
            신우전기는 1995년 설립 이래로 전력 변환 장치 및 전력 제어 시스템 분야에서 혁신적인 솔루션을 제공해온 선도적인 전기 기업입니다. 
      ...
      >
        {[
          ...
          <motion.div
            key={index}
            className="bg-white rounded-xl shadow-lg p-10 text-center hover:shadow-2xl transition-all duration-300 border border-gray-100"
